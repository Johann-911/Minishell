...
/*   Updated: 2025/11/06 17:49:14 by kskender         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	while (1)
	{
		...
		{
			/* Debug: print args for builtins (temporary) */
			if (args[0] && !strcmp(args[0], "echo"))
			{
				for (int di = 0; args[di]; ++di)
					fprintf(stderr, "DBG echo arg[%d]=<%s>\n", di, args[di]);
			}
